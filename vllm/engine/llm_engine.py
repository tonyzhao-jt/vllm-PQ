...
class LLMEngine:
    ...
    def _process_model_outputs(self,
        ...
        for i in indices:
            ...
            if seq_group.is_finished():
                # Set inband metrics
                self._get_stats(scheduler_outputs=scheduler_outputs,model_output=outputs)
        ...
        if scheduler_outputs is not None:
            ...
            for idx, scheduled_seq_group in enumerate(
                ...
                if seq_group.is_finished():
                    ...
                    # In band metrics
                    seq_group.metrics.gpu_kv_cache_utilization = gpu_cache_usage_sys or 0.0
                    seq_group.metrics.cpu_kv_cache_utilization = cpu_cache_usage_sys or 0.0
