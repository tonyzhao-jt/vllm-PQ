...
class LLMEngine:
    ...
    def _get_stats(self,
        ...
        # - preempted: https://github.com/vllm-project/vllm/blob/3db0cafdf1fe7f4cd7e41a145f78e8a568b4d63c/vllm/core/scheduler.py#L825
        #     will decide based on uncached tokens
        # - prefill: https://github.com/vllm-project/vllm/blob/3db0cafdf1fe7f4cd7e41a145f78e8a568b4d63c/vllm/core/scheduler.py#L890
        #     will decide based on cached and uncached tokens
        for scheduler in self.scheduler:
            for seq_group in scheduler.waiting:
                ...
                num_queue_tokens_iter += num_uncached_new_tokens + num_cached_new_tokens
