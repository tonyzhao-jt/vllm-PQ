...
class ModelOptNvFp4LinearMethod(LinearMethodBase):
    ...
    input_scale: torch.float32, scalar , (global_act_amax /
                                         (E2M1_max * E4M3_max))
    weight: NVFP4(represented as byte) Shape: [1, X, y/2]
    weight_scale: FP8-E4M3, Shape: [X, Y], aka per block scale,
        fp8_cast(per_block_amax /  (E2M1_max * weight_scaling_factor_2))
    weight_scale_2: torch.float32, scalar, (global_weight_amax 
                                        / (E2M1_max * E4M3_max))
    
    The weights are quantized per block of `group_size` 16 elements.
    Args: quant_config: The ModelOpt quantization config.
    """
